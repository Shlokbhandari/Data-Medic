...
DataMedic is an actively growing project. Currently, it fully handles two of our MVP failure types end-to-end:
- **Duplicate transaction IDs**: Detected, diagnosed, patched, validated, and pushed.
- **Suspicious zero values**: Detected, diagnosed, patched (isolated into a flagged file to prevent data loss), validated, and pushed.

It also successfully monitors and detects one other issue, which is currently escalated to a human (auto-fixing is not yet built):
- **Missing prices**
